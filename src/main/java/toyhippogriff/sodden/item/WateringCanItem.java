...
public class WateringCanItem extends Item {
    ...
    public WateringCanItem(WateringCanMaterial material) {
        super(new Item.Settings().group(ItemGroup.TOOLS).maxDamage(material.getCapacity()));
            ...
            if(growFlowers && block instanceof GrassBlock) {
                ...
                if(world.isAir(aboveBlockPos)) {
                    ...
                    if(!features.isEmpty()) {
                        ...
                        BlockState flowerBlockState = flowerFeature.getFlowerToPlace(world.random, aboveBlockPos, FeatureConfig.DEFAULT);
